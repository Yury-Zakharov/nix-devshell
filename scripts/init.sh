...
# Dynamic modules (single source of truth)
...
# Replace extraModules block (exact indent match to template)
NEW_BLOCK=$'      # Single declaration site for this project'\''s modules\n      extraModules = [\n        devshell.modules.base'
